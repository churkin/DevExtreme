import {
  getMovingSides, getAreaFromElement, getAreaFromObject, getDragOffsets, getOffsets,
} from '../utils';

jest.mock('../../../../core/utils/dom', () => ({
...
describe('Utils', () => {
  ...
  describe('getOffsets', () => {
    it('should include size if handle element is used', () => {
      const offset = { x: 100, y: 200 };
      const handleEl: any = {
        className: 'dx-resizable-handle-bottom dx-resizable-handle-right',
      };

      expect(getOffsets(offset, handleEl))
        .toEqual({ x: 110, y: 210 });
    });

    it('should return zero if offset is too small', () => {
      const offset = { x: 1, y: 1 };
      const handleEl: any = {
        className: 'dx-resizable-handle-left dx-resizable-handle-top',
      };
    ...
    it('should reset current offset if handle element is not used', () => {
      const offset = { x: 100, y: 200 };
      const handleEl: any = {
        className: '',
      };
